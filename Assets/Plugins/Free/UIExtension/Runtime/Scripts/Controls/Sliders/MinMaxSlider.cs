...
namespace UnityEngine.UI.Extensions
{
    ...
    public class MinMaxSlider : Selectable, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        [SerializeField] RectTransform sliderBounds = null;
        [SerializeField] RectTransform minHandle = null;
        [SerializeField] RectTransform maxHandle = null;
        [SerializeField] RectTransform middleGraphic = null;

        // text components (optional)
        [Header("Display Text (Optional)")]
        [SerializeField]
        TextMeshProUGUI minText = null;
        [SerializeField] TextMeshProUGUI maxText = null;
        ...
        [SerializeField]
        float minLimit = 0;
        [SerializeField] float maxLimit = 100;

        [Header("Values")]
        public bool wholeNumbers;
        [SerializeField] float minValue = 25;
        [SerializeField] float maxValue = 75;
        ...
        float dragStartMinValue01;
        float dragStartMaxValue01;
        DragState dragState;
        bool passDragEvents; // this allows drag events to be passed through to scrollers

        Camera mainCamera;
        Canvas parentCanvas;
        bool isOverlayCanvas;
        ...
        void PassDragEvents<T>(Action<T> callback) where T : IEventSystemHandler
        {
        ...
        void SetMaxHandleValue01(RectTransform handle, float value01)
        {
        ...
        /// <param name="handle"></param>
        /// <param name="value01">Normalized handle position</param>
        void SetMinHandleValue01(RectTransform handle, float value01)
        {
        ...
        float GetMaxHandleValue01(RectTransform handle)
        {
        ...
        float GetMinHandleValue01(RectTransform handle)
        {
        ...
        float GetValueOfPointInSliderBounds01(Vector2 position)
        {
        ...
        /// <returns></returns>
        static float GetPercentage(float min, float max, float input)
        {
